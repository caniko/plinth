...
// description: How I built Plinth, a Leptos-powered blog with SurrealDB and Typst support
...
- Server functions that call SurrealDB directly
...
Building your own tools teaches you things no framework can. The constraints of SurrealDB's `SCHEMAFULL` mode forced better data modeling. The Nix sandbox forced proper dependency management.
```
...
---
title: Building a Blog Engine in Rust
description: How I built Plinth with Leptos, SurrealDB, and Typst
tags: ["rust", "leptos", "web"]
featured: true
---
...
- Full-stack Rust
- Server functions calling SurrealDB directly
...
| SurrealDB | Graph + document in one |
...
- **description**: 120-160 characters. Summarize the post's value, not just its topic. Good: "Learn how to build a full-stack Rust blog with Leptos SSR and SurrealDB — from zero to deployed." Bad: "A post about Rust."
