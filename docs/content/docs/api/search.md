+++
title = "Search API"
description = "Semantic search, related articles, and opinion tracking"
weight = 20
+++
...
The query text is embedded into a 384-dimensional vector and compared against all article embeddings using cosine similarity.
